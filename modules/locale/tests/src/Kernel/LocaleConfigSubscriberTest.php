...
class LocaleConfigSubscriberTest extends KernelTestBase {
   ...
   *   The language code.
   */
  protected function setUpNoTranslation(string $config_name, string $key, $source, string $langcode): void {
   ...
   */
  protected function setUpTranslation($config_name, string $key, $source, $translation, $langcode, $is_active = FALSE): void {
   ...
   *   Whether the update will affect the active configuration.
   */
  protected function saveLocaleTranslationData($config_name, string $key, $source, $translation, $langcode, $is_active = FALSE): void {
    $this->localeConfigManager->reset();
    $this->localeConfigManager
      ->getStringTranslation($config_name, $langcode, $source, '')
      ->setString($translation)
   ...
   *   The language code.
   */
  protected function deleteLocaleTranslationData($config_name, string $key, $source_value, $langcode): void {
    $this->localeConfigManager
