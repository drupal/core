...
trait FileFieldCreationTrait {
   ...
   *   The file field.
   */
  protected function createFileField($name, $entity_type, $bundle, array $storage_settings = [], $field_settings = [], $widget_settings = []) {
   ...
   *   A list of widget settings that will be added to the widget defaults.
   */
  protected function attachFileField($name, $entity_type, $bundle, array $field_settings = [], $widget_settings = []) {
    $field = [
      'field_name' => $name,
      'label' => $name,
      'entity_type' => $entity_type,
