...
class LinkOptions extends ProcessPluginBase {
  ...
  public function __construct(array $configuration, $plugin_id, $plugin_definition) {
    @trigger_error(__CLASS__ . ' is deprecated in drupal:12.0.0 and is removed from drupal:13.0.0. Use \Drupal\migrate\Plugin\migrate\process\LinkOptions instead. See https://www.drupal.org/node/3533560', E_USER_DEPRECATED);
